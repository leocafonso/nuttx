...
#define R_SYSTEM_VBTCR1_OFFSET            0x041f
...
#define R_SYSTEM_CKOCR_CKODIV             (3 <<  4) /* 10: Clock out input frequency Division Select */
#define R_SYSTEM_CKOCR_CKODIV_MASK             (0x07)
#define R_SYSTEM_CKOCR_CKOSEL             (3 <<  0) /* 01: Clock out source select */
...
#define R_SYSTEM_SLCDSCKCR_LCDSCKSEL      (3 <<  0) /* 01: LCD Source Clock (LCDSRCCLK) Select */
...
#define R_SYSTEM_MOCOUTCR_MOCOUTRM        (8 <<  0) /* 01: MOCO User Trimming 1000_0000 : -128 1000_0001 : -127 1000_0010 : -126 . . . 1111_1111 : -1 0000_0000 : Center Code 0000_0001 : +1 . . . 0111_1101 : +125 0111_1110 : +126 0111_1111 : +127 These bits are added to original MOCO trimming bits */
...
#define R_SYSTEM_HOCOUTCR_HOCOUTRM        (8 <<  0) /* 01: HOCO User Trimming 1000_0000 : -128 1000_0001 : -127 1000_0010 : -126 . . . 1111_1111 : -1 0000_0000 : Center Code 0000_0001 : +1 . . . 0111_1101 : +125 0111_1110 : +126 0111_1111 : +127 These bits are added to original HOCO trimming bits */
...
#define R_SYSTEM_MOSCWTCR_MSTS            (4 <<  0) /* 01: Main clock oscillator wait time setting */
...
#define R_SYSTEM_HOCOWTCR_HSTS            (3 <<  0) /* 01: HOCO wait time setting */
...
#define R_SYSTEM_OPCCR_OPCM               (2 <<  0) /* 01: Operating Power Control Mode Select */
...
#define R_SYSTEM_LVDLVLR_LVD2LVL          (3 <<  5) /* 20: Voltage Detection 2 Level Select (Standard voltage during drop in voltage) */
#define R_SYSTEM_LVDLVLR_LVD2LVL_MASK          (0x07)
#define R_SYSTEM_LVDLVLR_LVD1LVL          (5 <<  0) /* 01: Voltage Detection 1 Level Select (Standard voltage during drop in voltage) */
#define R_SYSTEM_LVDLVLR_LVD1LVL_MASK          (0x1f)
#define R_SYSTEM_LVDCR0_SIZE              2
#define R_SYSTEM_LVDCR0_OFFSET            0x041a
#define R_SYSTEM_LVDCR0(p)                (R_SYSTEM_BASE + R_SYSTEM_LVDCR0_OFFSET + (p)*0x0001)
...
#define R_SYSTEM_LVDCR1(p)                (R_SYSTEM_BASE + R_SYSTEM_LVDCR1_OFFSET + (p)*0x0002)
#define R_SYSTEM_LVDCR1_IRQSEL            (1 <<  2) /* 04: Voltage Monitor Interrupt Type Select */
#define R_SYSTEM_LVDCR1_IDTSEL            (2 <<  0) /* 01: Voltage Monitor Interrupt Generation Condition Select */
#define R_SYSTEM_LVDCR1_IDTSEL_MASK            (0x03)
#define R_SYSTEM_LVDSR_SIZE               2
#define R_SYSTEM_LVDSR_OFFSET             0x00e1
#define R_SYSTEM_LVDSR(p)                 (R_SYSTEM_BASE + R_SYSTEM_LVDSR_OFFSET + (p)*0x0002)
...
#define R_SYSTEM_PRCR_PRKEY               (8 <<  8) /* 100: PRC Key Code */
...
#define R_SYSTEM_BKRACR_BKRACS            (3 <<  0) /* 01: Backup Register Access Control Register */
