...
#  define R_SYSTEM_SCKDIVCR_FCK_DIV_CLEAR       (R_SYSTEM_SCKDIVCR_FCK_MASK << R_SYSTEM_SCKDIVCR_FCK_SHIFT) 
...
#  define R_SYSTEM_SCKDIVCR_ICK_DIV_CLEAR       (R_SYSTEM_SCKDIVCR_ICK_MASK << R_SYSTEM_SCKDIVCR_ICK_SHIFT) 
...
#  define R_SYSTEM_SCKDIVCR_PCKA_DIV_CLEAR       (R_SYSTEM_SCKDIVCR_PCKA_MASK << R_SYSTEM_SCKDIVCR_PCKA_SHIFT) 
...
#  define R_SYSTEM_SCKDIVCR_PCKB_DIV_CLEAR       (R_SYSTEM_SCKDIVCR_PCKB_MASK << R_SYSTEM_SCKDIVCR_PCKB_SHIFT) 
...
#  define R_SYSTEM_SCKDIVCR_PCKC_DIV_CLEAR       (R_SYSTEM_SCKDIVCR_PCKC_MASK << R_SYSTEM_SCKDIVCR_PCKC_SHIFT) 
...
#  define R_SYSTEM_SCKDIVCR_PCKD_DIV_CLEAR       (R_SYSTEM_SCKDIVCR_PCKD_MASK << R_SYSTEM_SCKDIVCR_PCKD_SHIFT) 
...
# define R_SYSTEM_SCKSCR_CKSEL_CLEAR      (R_SYSTEM_SCKSCR_CKSEL_MASK << R_SYSTEM_SCKSCR_CKSEL_SHIFT) 
